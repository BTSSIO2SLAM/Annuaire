...
<div class="well">
    ...
    <form href= "index2.php?action=addsite" class="form-horizontal" role="form" enctype="multipart/form-data" method='POST'> 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <?php
                ...
                {
                    ?>
                    <option value="<?php echo $categorie['ID_cat_site']; ?>"><?php echo $categorie['Nom_cat_site']; ?></option>
                    <?php
                }
                ?>
            </select>
