...
<h2 class=text-center> Changer une photo </h2>
<div class="well">

<form action= "index.php?action=ConfirmerEditPhoto" class="form-horizontal" role="form" enctype="multipart/form-data" method='POST'>
